...
public class SecureChatClientInitializer extends ChannelInitializer<SocketChannel> {
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		if (SSLMODE.CA.toString().equals(tlsMode)) {
			engine = SecureChatSslContextFactory.getClientContext(tlsMode, null,
			...
			engine = SecureChatSslContextFactory
					.getClientContext(tlsMode, System.getProperty("user.dir") + "/src/com/phei/netty/ssl/conf/twoway/cChat.jks",
