...
public class SecureChatServerInitializer extends ChannelInitializer<SocketChannel> {
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		if (SSLMODE.CA.toString().equals(tlsMode)) {
			engine = SecureChatSslContextFactory.getServerContext(tlsMode,
			...
			engine = SecureChatSslContextFactory
					.getServerContext(tlsMode, System.getProperty("user.dir") + "/src/com/phei/netty/ssl/conf/twoway/sChat.jks",
